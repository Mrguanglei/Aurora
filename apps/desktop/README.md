...
Minimal Electron wrapper for the Aurora web application with deep linking support.

## Features

- Native macOS/Windows/Linux desktop app
- Deep linking for magic link authentication (`Aurora://` protocol)
...
By default, it loads `https://Aurora.com/`.
...
The app registers the `Aurora://` protocol for magic link authentication:

1. User enters email in desktop app
2. Magic link email contains `Aurora://auth/callback?code=xxx`
3. User clicks link in email
4. Operating system opens Aurora Desktop app
