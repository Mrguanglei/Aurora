...
"""
    ...
    async def _fetch_user_memories(user_id: Optional[str], thread_id: str, client) -> Optional[str]:
        ...
        try:
            ...
            user_memory_result = await client.rpc('get_user_memory_enabled', {'p_account_id': user_id})
            ...
            thread_memory_result = await client.rpc('get_thread_memory_enabled', {'p_thread_id': thread_id})
