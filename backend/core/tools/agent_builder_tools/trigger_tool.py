        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {
                        "type": "string",
                        "description": "Model to use for the scheduled execution. Options: 'Aurora/basic' (default, free tier) or 'kortix/power' (requires paid subscription). If not specified, defaults to 'Aurora/basic'."
                    }
                },
        ...
        try:
            ...
            for trigger in schedule_triggers:
                formatted = {
                    ...
                    "model": trigger.config.get("model", "Aurora/basic"),
                    "is_active": trigger.is_active
                }
        ...
        "function": {
            ...
            "parameters": {
                ...
                "properties": {
                    ...
                    "model": {"type": "string", "description": "Model to use for the event execution. Options: 'Aurora/basic' (default, free tier) or 'kortix/power' (requires paid subscription). If not specified, defaults to 'Aurora/basic'."}
                },
