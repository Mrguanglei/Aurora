...
class ModelManager:
    ...
    def resolve_model_id(self, model_id: str) -> str:
        ...
        Handles:
        - Registry model IDs (Aurora/basic) → returns as-is
        - Model aliases → resolves to registry ID
        - LiteLLM model IDs (Bedrock ARNs) → reverse lookup to registry ID (e.g. Aurora/basic)
        """
        ...
        # Try reverse lookup from LiteLLM model ID (e.g. Bedrock ARN → Aurora/basic)
