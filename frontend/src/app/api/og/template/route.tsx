...
export async function GET(request: NextRequest) {
  try {
    ...
    const templateResponse = await fetch(
      `${process.env.NEXT_PUBLIC_BACKEND_URL || 'http://localhost:8011/v1'}/templates/public/${shareId}`
    );
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              <span style={{ color: '#64748b', fontSize: '20px' }}>Aurora</span>
      ...
      (
        ...
        >
          ...
          >
            ...
            >
              Discover powerful AI agents on Aurora
            </p>
          </div>
        </div>
      ),
