...
export async function generateMetadata({ params }): Promise<Metadata> {
  ...
  const fallbackMetaData = {
    title: 'Shared Conversation | Aurora',
    description: 'Replay this Worker conversation on Aurora',
    alternates: {
  ...
  try {
    ...
    const title = projectData.name || 'Shared Conversation | Aurora';
    const description =
      projectData.description ||
      'Replay this Agent conversation on Aurora';
