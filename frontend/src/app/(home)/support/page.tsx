              ...
              <div className="flex flex-col items-center justify-center gap-6 pt-12 max-w-4xl mx-auto pb-16">
                ...
                <div className="flex flex-col sm:flex-row items-center gap-4 pt-4">
                  <Button asChild size="lg" className="text-base h-14 w-48 rounded-full px-8">
                    <a href="mailto:support@botsmart.cn">
                ...
                <p className="text-sm text-muted-foreground">
                  Or email us directly at <a href="mailto:support@botsmart.cn" className="text-primary hover:underline font-medium">support@botsmart.cn</a>
                </p>
              </div>
            </div>
          </div>
            ...
            <div className="max-w-6xl mx-auto border-l border-r border-border">
              ...
              <div className="border-t border-border">
                ...
                <FAQItem
                  ...
                  answer={
                    <>
                      If your credits don't appear after payment, contact <a href="mailto:support@botsmart.cn" className="text-primary hover:underline font-medium">support@botsmart.cn</a> immediately. We prioritize billing and credit issues for all users regardless of tier and will resolve this as quickly as possible, typically within a few hours during business days.
                    </>
                  }
                />
              </div>
                      ...
                      <div className="space-y-4">
                        <div className="p-4 rounded-lg border bg-accent/5">
                          ...
                          <p className="text-muted-foreground text-sm mb-3">
                            ...
                            <a href="mailto:support@botsmart.cn" className="text-primary hover:underline font-medium">
                              support@botsmart.cn
                            </a>
