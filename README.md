...
[![Twitter Follow](https://img.shields.io/twitter/follow/Aurora)](https://x.com/korti)
[![GitHub Repo stars](https://img.shields.io/github/stars/Aurora-ai/suna)](https://github.com/Aurora-ai/suna)
[![Issues](https://img.shields.io/github/issues/Aurora-ai/suna)](https://github.com/Aurora-ai/suna/labels/bug)

<!-- Keep these links. Translations will automatically update with the README. -->
[Deutsch](https://www.readme-i18n.com/Aurora-ai/suna?lang=de) | 
[Español](https://www.readme-i18n.com/Aurora-ai/suna?lang=es) | 
[français](https://www.readme-i18n.com/Aurora-ai/suna?lang=fr) | 
[日本語](https://www.readme-i18n.com/Aurora-ai/suna?lang=ja) | 
[한국어](https://www.readme-i18n.com/Aurora-ai/suna?lang=ko) | 
[Português](https://www.readme-i18n.com/Aurora-ai/suna?lang=pt) | 
[Русский](https://www.readme-i18n.com/Aurora-ai/suna?lang=ru) | 
[中文](https://www.readme-i18n.com/Aurora-ai/suna?lang=zh)

![Aurora Screenshot](frontend/public/banner.png)
</div>
...
### 🤖 Includes Aurora Super Worker – Flagship Generalist AI Worker
Meet Aurora Super Worker, our showcase agent that demonstrates the full power of the Aurora platform. Through natural conversation, Aurora Super Worker handles research, data analysis, browser automation, file management, and complex workflows – showing you what's possible when you build with Aurora.

### 🔧 Build Custom Aurora Super Worker-Type Agents
Create your own specialized agents tailored to specific domains, workflows, or business needs. Whether you need agents for customer service, data processing, content creation, or industry-specific tasks, Aurora provides the infrastructure and tools to build, deploy, and scale them.
...
- [🌟 What Makes Aurora Special](#-what-makes-Aurora-special)
...
### Aurora Super Worker - Your Generalist AI Worker

Aurora Super Worker demonstrates the full capabilities of the Aurora platform as a versatile AI worker that can:
...
The Aurora platform enables you to create agents tailored to specific needs:
...
Aurora consists of four main components that work together to provide a complete AI agent development platform:
...
Get your Aurora platform running in minutes with our automated setup wizard:

### 1️⃣ Clone the Repository
```bash
git clone https://github.com/Aurora-ai/suna.git
cd suna
```
...
That's it! Your Aurora platform will be running with Aurora Super Worker ready to assist you.
...
[Get Started](./docs/SELF-HOSTING.md) • [Join Discord](https://discord.gg/RvFhXUdZ9H) • [Follow on Twitter](https://x.com/Aurora)
